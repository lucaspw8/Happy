...
export default function OrfanatoDetalhes() {
  ...
  const params =  route.params as ParamsOrfanato;
    ...
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.description}>{orfanato.about}</Text>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={AbrirMapa} style={styles.routesContainer}>
        ...
        <View style={styles.scheduleContainer}>
          <View style={[styles.scheduleItem, styles.scheduleItemBlue]}>
            ...
            <Text style={[styles.scheduleText, styles.scheduleTextBlue]}>{orfanato.opening_hours}</Text>
          </View>
